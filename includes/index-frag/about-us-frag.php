        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-8 order-md-2">
                    <h2 class="featurette-heading">Consort organisation<span class="text-muted"> Le sauveur de ton sauveur.</span></h2>
                    <p class="lead">Nous sommes une entreprise de promotion, Nous avons pour but de promouvoir les laboratoires de recherche et de développement dans certains regions et de proposer nos produits aux pharmarcies et aux hopitaux par le biais de nos delegues.
                    </p>

                    </p>
                </div>
                <div class="col-md-4 order-md-1">
                    <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="300" height="300" src="./assets/images/logo/logo.png" alt="">
                </div>
            </div>
        </div>
        <section class="clean-block about-us">
            <div class="container">
                <div class="block-heading">
                    ...
                    <p>Les membres de consort.</p>
                </div>
                <?php
                if (isset($res_delegue) && !empty($res_delegue)) {
                    echo '<div class="row justify-content-center">';
                    foreach ($res_delegue as $row) {
                ?>
                        <div class="col-sm-6 col-lg-4">
                            <div class="card text-center clean-card"><img class="card-img-top w-100 d-block" src="./assets/images/delegue/<?php echo $row["photo"] ?>" width="150" height="150">
                                <div class="card-body info">
                                    <h4 class="card-title"><?php echo $row["nom"] . ' ' . $row["prenom"] ?></h4>
                                    <p class="card-text">Fonction : <?php echo $row["fonction"] ?>.</p>
                                    <div class="icons"><a href="#"><i class="fab fa-facebook"></i></a><a href="#"><i class="fab fa-instagram"></i></a><a href="#"><i class="fab fa-twitter"></i></a></div>
                                </div>
                            </div>
                        </div>
                <?php
        ...
        <footer class="py-5">
            <div class="row">
                ...
                <div class="col-4 offset-1">
                    <form method="post" action="user.manager.php?provider=about-us">
                        <h5>Abonnement</h5>
